                ...
                <main className="flex-grow px-4 pt-8 md:pt-0">
                    <div className="flex flex-col items-center justify-center relative w-full gap-4">
                        ...
                        <div className="flex relative justify-center items-center w-full mt-2 px-4">
                            <div className="absolute w-[32%] md:w-[38%] left-8 md:left-0 lg:left-[-8%] md:bottom-[30%] top-[-3%] md:top-auto flex justify-center">
                                <Image
                                    src="/assets/male.png"
                                    alt="Character Left"
                                    width={720}
                            ...
                            <div className="absolute w-[32%] md:w-[38%] right-8 md:right-0 lg:right-[-8%] md:bottom-[30%] top-[-3%] md:top-auto flex justify-center transform scale-x-[-1]">
                                <Image
                                    src="/assets/male.png"
                                    alt="Character Right"
                                    width={720}
